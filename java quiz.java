...
public class quiz implements ActionListener{
    ...
    String[] questions = 	{
            ...
            "Who's the best java teacher alive?",
            "Who is credited with creating Java?"
    };
    String[][] options = 	{
            {"Sun Microsystems","GP Vikramgad","Microsoft","Alphabet"},
            {"1989","1996","1972","1492"},
            {"Mohan Mishra","Bill Gates","Sushil Gawde","Dennis Ritchi"},
            {"Steve Jobs","Atharva Barge","James Gosling","Mark Zuckerburg"}
    };
    char[] answers = 		{
            'A',
            'B',
    ...
    public quiz() {
        ...
        time_label.setFont(new Font("Times New Roman",Font.PLAIN,20));
